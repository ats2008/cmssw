...
TrackingRegionOfInteret = 'hltPixelTracksTrackingRegionsL3MuonNoVtx'
TrackCollectionOfInterest = 'hltPixelTracksL3MuonNoVtx'
ValidationIdx = 'TROI_29_TCOI_1' 



ValidationRawFile = ValidationIdx + "_validation.root"
summary_file=ValidationIdx + "_summary.md"
deltaRCUT=0.05
...
print "\n\n'''\n"
print str(evtCount) ,
print "\t"+str(trigEvtCount),
print "\t"+str(true_trk_count),
print "\t"+str(RvR_trk_count),
print "\t"+str(RvR_missInTruth_trk_count),
print "\t"+str(GvR_trk_count),
print "\t"+str(GvR_match_trk_count),
print "\t"+str(GvR_missInTruth_trk_count),
print "\t"+str(GvR_addl_trk_count) ,
print "\t\n'''"
